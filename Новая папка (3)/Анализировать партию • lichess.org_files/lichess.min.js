...
!function(){for(var e,t={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"ins",46:"del",91:"meta",93:"meta",224:"meta"},n={106:"*",107:"+",109:"-",110:".",111:"/",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'"},a={option:"alt",command:"meta",return:"enter",escape:"esc",plus:"+",mod:/Mac|iPod|iPhone|iPad/.test(navigator.platform)?"meta":"ctrl"},r=1;r<20;++r)t[111+r]="f"+r;for(r=0;r<=9;++r)t[r+96]=r.toString();function o(e){if("keypress"==e.type){var a=String.fromCharCode(e.which);return e.shiftKey||(a=a.toLowerCase()),a}return t[e.which]?t[e.which]:n[e.which]?n[e.which]:String.fromCharCode(e.which).toLowerCase()}function i(e){return"shift"==e||"ctrl"==e||"alt"==e||"meta"==e}function c(n,a,r){return r||(r=function(){if(!e)for(var n in e={},t)n>95&&n<112||t.hasOwnProperty(n)&&(e[t[n]]=n);return e}()[n]?"keydown":"keypress"),"keypress"==r&&a.length&&(r="keydown"),r}function s(e,t){var n,r,o,s=[];for(n=function(e){return"+"===e?["+"]:(e=e.replace(/\+{2}/g,"+plus")).split("+")}(e),o=0;o<n.length;++o)r=n[o],a[r]&&(r=a[r]),i(r)&&s.push(r);return{key:r,modifiers:s,action:t=c(r,s,t)}}function l(e){var t=this;if(e=e||document,!(t instanceof l))return new l(e);t.target=e,t._callbacks={};var n,a={},r=!1,c=!1,u=!1;function f(e){e=e||{};var t,n=!1;for(t in a)e[t]?n=!0:a[t]=0;n||(u=!1)}function h(e,n,r,o,c,s){var l,u,f,h,p=[],y=r.type;if(!t._callbacks[e])return[];for("keyup"==y&&i(e)&&(n=[e]),l=0;l<t._callbacks[e].length;++l)if(u=t._callbacks[e][l],(o||!u.seq||a[u.seq]==u.level)&&y==u.action&&("keypress"==y&&!r.metaKey&&!r.ctrlKey||(f=n,h=u.modifiers,f.sort().join(",")===h.sort().join(",")))){var d=!o&&u.combo==c,m=o&&u.seq==o&&u.level==s;(d||m)&&t._callbacks[e].splice(l,1),p.push(u)}return p}function p(e,t,n){const a=t.target;("esc"==n||"INPUT"!=a.tagName&&"SELECT"!=a.tagName&&"TEXTAREA"!=a.tagName&&!a.isContentEditable)&&(e(),t.preventDefault(),t.stopPropagation())}function y(e){"number"!=typeof e.which&&(e.which=e.keyCode);var n=o(e);n&&("keyup"!=e.type||r!==n?t._handleKey.call(t,n,function(e){var t=[];return e.shiftKey&&t.push("shift"),e.altKey&&t.push("alt"),e.ctrlKey&&t.push("ctrl"),e.metaKey&&t.push("meta"),t}(e),e):r=!1)}function d(e,t,i,c){function l(t){return function(){u=t,++a[e],clearTimeout(n),n=setTimeout(f,1e3)}}function h(t){p(i,t,e),"keyup"!==c&&(r=o(t)),setTimeout(f,10)}a[e]=0;for(var y=0;y<t.length;++y){var d=y+1===t.length?h:l(c||s(t[y+1]).action);m(t[y],d,c,e,y)}}function m(e,n,a,r,o){var i,c=(e=e.replace(/\s+/g," ")).split(" ");c.length>1?d(e,c,n,a):(i=s(e,a),t._callbacks[i.key]=t._callbacks[i.key]||[],h(i.key,i.modifiers,{type:i.action},r,e,o),t._callbacks[i.key][r?"unshift":"push"]({callback:n,modifiers:i.modifiers,action:i.action,seq:r,level:o,combo:e}))}t._handleKey=function(e,t,n){var a,r=h(e,t,n),o={},s=0,l=!1;for(a=0;a<r.length;++a)r[a].seq&&(s=Math.max(s,r[a].level));for(a=0;a<r.length;++a)if(r[a].seq){if(r[a].level!=s)continue;l=!0,o[r[a].seq]=1,p(r[a].callback,n,r[a].combo)}else l||p(r[a].callback,n,r[a].combo);var y="keypress"==n.type&&c;n.type!=u||i(e)||y||f(o),c=l&&"keydown"==n.type},t._bindMultiple=function(e,t,n){e.forEach(e=>m(e,t,n))},e.addEventListener("keypress",y),e.addEventListener("keydown",y),e.addEventListener("keyup",y)}l.prototype.bind=function(e,t,n){return this._bindMultiple.call(this,e instanceof Array?e:[e],t,n),this},window.Mousetrap=new l}();!function(){"use strict";const e=e=>`lichess-${e}`,t=(t,s)=>t[e(s)],s=(t,s,n)=>t[e(s)]=n,n=e=>{const[t,s,n]=e.getAttribute("data-state").split(",");o(e,t,s,n)},o=(e,t,o,i)=>{window.Chessground?s(e,"chessground",window.Chessground(e,{orientation:o,coordinates:!1,viewOnly:!e.getAttribute("data-playable"),fen:t,lastMove:i&&("@"===i[1]?[i.slice(2)]:[i[0]+i[1],i[2]+i[3]]),drawable:{enabled:!1,visible:!1}})):setTimeout((()=>n(e)),500)},i=e=>Array.from((e||document).getElementsByClassName("mini-board--init")).forEach(n);var a=Object.freeze(Object.defineProperty({__proto__:null,init:n,initWith:o,initAll:i},Symbol.toStringTag,{value:"Module"}));function r(e,n){const o=t(e,"clock");o?o.set(n):s(e,"clock",new c(e,n))}class c{constructor(e,t){this.el=e,this.opts=t,this.set=e=>{this.opts=e,this.target=1e3*e.time+Date.now(),this.render(),clearInterval(this.interval),e.pause||(this.interval=setInterval(this.render,1e3))},this.render=()=>{document.body.contains(this.el)?(this.el.textContent=l(this.target-Date.now()),this.el.classList.toggle("clock--run",!this.opts.pause)):clearInterval(this.interval)},this.target=1e3*t.time+Date.now(),t.pause||(this.interval=setInterval(this.render,1e3)),this.render()}}const l=e=>{const t=new Date(Math.max(0,e+500)),s=t.getUTCHours(),n=t.getUTCMinutes(),o=t.getUTCSeconds();return s>0?s+":"+d(n)+":"+d(o):n+":"+d(o)},d=e=>(e<10?"0":"")+e,h=e=>null!=e,u={cache:"no-cache",credentials:"same-origin"},p={"X-Requested-With":"XMLHttpRequest"},m=(e,t={})=>g(e,t).then((e=>(e=>{if(e.ok)return e;if(429==e.status)throw new Error("Too many requests");if(413==e.status)throw new Error("The uploaded file is too large");throw new Error(`Error ${e.status}`)})(e).text())),g=(e,t={})=>fetch(e,{...u,headers:{...p},...t}),f=e=>{const t=new FormData;for(const s of Object.keys(e))t.append(s,e[s]);return t};function b(e,t,s){const n=["mousemove","touchstart"];let o=!1,i=!0,a=performance.now();const r=()=>{i||s(),i=!0,a=performance.now(),c()},c=()=>{o&&(n.forEach((e=>document.removeEventListener(e,r))),o=!1)};setInterval((()=>{i&&performance.now()-a>e&&(t(),i=!1),o||(n.forEach((e=>document.addEventListener(e,r))),o=!0)}),1e4)}let v;try{const e=window.crypto.getRandomValues(new Uint8Array(9));v=btoa(String.fromCharCode(...e)).replace(/[/+]/g,"_")}catch(Ee){v=Math.random().toString(36).slice(2,12)}const w=v;let y=!1;const k=e=>{let t;if("string"==typeof e)t=e;else if(t=e.url,e.cookie){const t=document.domain.replace(/^.+(\.[^.]+\.[^.]+)$/,"$1"),s=[encodeURIComponent(e.cookie.name)+"="+e.cookie.value,"; max-age="+e.cookie.maxAge,"; path=/","; domain="+t].join("");document.cookie=s}const s="//"+location.host+"/"+t.replace(/^\//,"");y=s,location.href=s},S={expected:!1},C=()=>{y||(S.expected=!0,lichess.socket.disconnect(),location.hash?location.reload():location.assign(location.href))},_=e=>{const t={get:t=>e.getItem(t),set:(t,s)=>e.setItem(t,s),fire:(t,s)=>e.setItem(t,JSON.stringify({sri:w,nonce:Math.random(),value:s})),remove:t=>e.removeItem(t),make:s=>({get:()=>t.get(s),set:e=>t.set(s,e),fire:e=>t.fire(s,e),remove:()=>t.remove(s),listen:t=>window.addEventListener("storage",(n=>{if(n.key!==s||n.storageArea!==e||null===n.newValue)return;let o;try{o=JSON.parse(n.newValue)}catch(Ee){return}(null==o?void 0:o.sri)&&o.sri!==w&&t(o)}))}),makeBoolean:e=>({get:()=>"1"==t.get(e),set:s=>t.set(e,s?"1":"0"),toggle:()=>t.set(e,"1"==t.get(e)?"0":"1")})};return t},T=_(window.localStorage),A=_(window.sessionStorage);function M(e,t){return"always"===t||!T.get(e)&&(T.set(e,"1"),!0)}const L=WebSocket.prototype.send;class E{constructor(e,t,s={}){this.url=e,this.pubsub=lichess.pubsub,this.ackable=new O(((e,t,s)=>this.send(e,t,s))),this.lastPingTime=performance.now(),this.pongCount=0,this.averageLag=0,this.tryOtherUrl=!1,this.autoReconnect=!0,this.nbConnects=0,this.storage=T.make("surl17"),this.sign=e=>{this._sign=e,this.ackable.sign(e)},this.connect=()=>{this.destroy(),this.autoReconnect=!0;const e=((e,t)=>{const s=new URLSearchParams;for(const o of Object.keys(t))void 0!==t[o]&&s.append(o,t[o]);const n=s.toString();return n?`${e}?${n}`:e})(this.options.protocol+"//"+this.baseUrl()+this.url,{...this.settings.params,v:!1===this.version?void 0:this.version});this.debug("connection attempt to "+e);try{const t=this.ws=new WebSocket(e);t.onerror=e=>this.onError(e),t.onclose=()=>{this.pubsub.emit("socket.close"),this.autoReconnect&&(this.debug("Will autoreconnect in "+this.options.autoReconnectDelay),this.scheduleConnect(this.options.autoReconnectDelay))},t.onopen=()=>{this.debug("connected to "+e),this.onSuccess();const t=document.body.classList;t.remove("offline"),t.add("online"),t.toggle("reconnected",this.nbConnects>1),this.pingNow(),this.pubsub.emit("socket.open"),this.ackable.resend()},t.onmessage=e=>{if(0==e.data)return this.pong();const t=JSON.parse(e.data);"n"===t.t&&this.pong(),this.handle(t)}}catch(t){this.onError(t)}this.scheduleConnect(this.options.pingMaxLag)},this.send=(e,t,s={},n=!1)=>{const o={t:e};void 0!==t&&(s.withLag&&(t.l=Math.round(this.averageLag)),s.millis>=0&&(t.s=Math.round(.1*s.millis).toString(36)),o.d=t),s.ackable&&(o.d=o.d||{},this.ackable.register(e,o.d));const i=JSON.stringify(o);if("racerScore"!=e||s.sign==this._sign){if("move"==e&&s.sign!=this._sign){let e;try{e=(new Error).stack.split("\n").join(" / ").replace(/\s+/g," ")}catch(a){e=`${a.message} ${navigator.userAgent}`}e.includes("round.nvui")||setTimeout((()=>{M(`socket.rep.${Math.round(Date.now()/1e3/3600/3)}`)?this.send("rep",{n:`soc: ${i} ${e}`}):lichess.socket.destroy()}),1e4)}this.debug("send "+i);try{L.apply(this.ws,[i])}catch(a){n||setTimeout((()=>this.send(e,o.d,s,!0)),1e3)}}},this.scheduleConnect=e=>{this.options.idle&&(e=1e4+10*Math.random()*1e3),clearTimeout(this.pingSchedule),clearTimeout(this.connectSchedule),this.connectSchedule=setTimeout((()=>{document.body.classList.add("offline"),document.body.classList.remove("online"),this.tryOtherUrl=!0,this.connect()}),e)},this.schedulePing=e=>{clearTimeout(this.pingSchedule),this.pingSchedule=setTimeout(this.pingNow,e)},this.pingNow=()=>{clearTimeout(this.pingSchedule),clearTimeout(this.connectSchedule);const e=this.options.isAuth&&this.pongCount%8==2?JSON.stringify({t:"p",l:Math.round(.1*this.averageLag)}):"null";try{this.ws.send(e),this.lastPingTime=performance.now()}catch(t){this.debug(t,!0)}this.scheduleConnect(this.options.pingMaxLag)},this.computePingDelay=()=>this.options.pingDelay+(this.options.idle?1e3:0),this.pong=()=>{clearTimeout(this.connectSchedule),this.schedulePing(this.computePingDelay());const e=Math.min(performance.now()-this.lastPingTime,1e4);this.pongCount++;const t=this.pongCount>4?.1:1/this.pongCount;this.averageLag+=t*(e-this.averageLag),this.pubsub.emit("socket.lag",this.averageLag)},this.handle=e=>{if(e.v&&!1!==this.version){if(e.v<=this.version)return void this.debug("already has event "+e.v);if(e.v>this.version+1)return C();this.version=e.v}switch(e.t||!1){case!1:break;case"resync":C();break;case"ack":this.ackable.onServerAck(e.d);break;default:this.settings.receive&&this.settings.receive(e.t,e.d)||(this.pubsub.emit("socket.in."+e.t,e.d,e),this.settings.events[e.t]&&this.settings.events[e.t](e.d||null,e))}},this.debug=(e,t=!1)=>{(t||this.options.debug)&&console.debug(e)},this.destroy=()=>{clearTimeout(this.pingSchedule),clearTimeout(this.connectSchedule),this.disconnect(),this.ws=void 0},this.disconnect=()=>{const e=this.ws;e&&(this.debug("Disconnect"),this.autoReconnect=!1,e.onerror=e.onclose=e.onopen=e.onmessage=()=>{},e.close())},this.onError=e=>{this.options.debug=!0,this.debug("error: "+JSON.stringify(e)),this.tryOtherUrl=!0,clearTimeout(this.pingSchedule)},this.onSuccess=()=>{if(this.nbConnects++,1==this.nbConnects){let e;E.resolveFirstConnect(this.send),b(6e5,(()=>{this.options.idle=!0,e=setTimeout(this.destroy,72e5)}),(()=>{this.options.idle=!1,this.ws?clearTimeout(e):location.reload()}))}},this.baseUrl=()=>{const e=document.body.dataset.socketDomains.split(",");let t=this.storage.get();return t&&!this.tryOtherUrl||(t=e[Math.floor(Math.random()*e.length)],this.storage.set(t)),t},this.pingInterval=()=>this.computePingDelay()+this.averageLag,this.getVersion=()=>this.version,this.settings={receive:s.receive,events:s.events||{},params:{...E.defaultParams,...s.params||{}}},this.options={...E.defaultOptions,...s.options||{}},this.version=t,this.pubsub.on("socket.send",this.send),window.addEventListener("unload",this.destroy),this.connect()}}E.defaultOptions={idle:!1,pingMaxLag:9e3,pingDelay:2500,autoReconnectDelay:3500,protocol:"https:"===location.protocol?"wss:":"ws:",isAuth:document.body.hasAttribute("user")},E.defaultParams={sri:w},E.firstConnect=new Promise((e=>{E.resolveFirstConnect=e}));class O{constructor(e){this.send=e,this.currentId=1,this.messages=[],this.sign=e=>this._sign=e,this.resend=()=>{const e=performance.now()-2500;this.messages.forEach((t=>{t.at<e&&this.send(t.t,t.d,{sign:this._sign})}))},this.register=(e,t)=>{t.a=this.currentId++,this.messages.push({t:e,d:t,at:performance.now()})},this.onServerAck=e=>{this.messages=this.messages.filter((t=>t.d.a!==e))},setInterval(this.resend,1200)}}const N=e=>e.indexOf(" b")>0?"black":"white",I=e=>{if(window.Chessground){const[t,n,o]=e.getAttribute("data-state").split(","),i={coordinates:!1,viewOnly:!0,fen:t,orientation:n,lastMove:o&&("@"===o[1]?[o.slice(2)]:[o[0]+o[1],o[2]+o[3]]),drawable:{enabled:!1,visible:!1}},a=$(e).removeClass("mini-game--init"),c=a.find(".cg-wrap"),l=N(t);s(c[0],"chessground",window.Chessground(c[0],i)),["white","black"].forEach((e=>a.find(".mini-game__clock--"+e).each((function(){r(this,{time:parseInt(this.getAttribute("data-time")),pause:e!=l||!D(t,e)})}))))}else setTimeout((()=>I(e)),200);return e.getAttribute("data-live")},D=(e,t)=>"white"==t?!e.includes("PPPPPPPP/RNBQKBNR"):!e.startsWith("rnbqkbnr/pppppppp"),x=e=>{const t=Array.from((e||document).getElementsByClassName("mini-game--init")).map(I).filter((e=>e));t.length&&E.firstConnect.then((e=>e("startWatching",t.join(" "))))},P=(e,s)=>{const n=$(e),o=s.lm,i=o&&("@"===o[1]?[o.slice(2)]:[o[0]+o[1],o[2]+o[3]]),a=t(e.querySelector(".cg-wrap"),"chessground");a&&a.set({fen:s.fen,lastMove:i});const c=N(s.fen),l=(e,t)=>{var o;isNaN(e)||r(null===(o=n[0])||void 0===o?void 0:o.querySelector(".mini-game__clock--"+t),{time:e,pause:t!=c||!D(s.fen,t)})};l(s.wc,"white"),l(s.bc,"black")},q=(e,t)=>["white","black"].forEach((s=>{const n=$(e).find(".mini-game__clock--"+s);n.data("managed")||n.replaceWith(`<span class="mini-game__result">${t?t==s[0]?1:0:"½"}</span>`)}));var U=Object.freeze(Object.defineProperty({__proto__:null,init:I,initAll:x,update:P,finish:q},Symbol.toStringTag,{value:"Module"}));function j(e,t){if(t.length)if(e.includes("%s"))e=e.replace("%s",t[0]);else for(let s=0;s<t.length;s++)e=e.replace("%"+(s+1)+"$s",t[s]);return e}function F(e,t){const s=e.split(/(%(?:\d\$)?s)/g);if(t.length){const e=s.indexOf("%s");if(-1!==e)s[e]=t[0];else for(let n=0;1<t.length;n++){const e=s.indexOf("%"+(n+1)+"$s");-1!==e&&(s[e]=t[n])}}return s}const R=e=>{const t=(t,...s)=>{const n=e[t];return n?j(n,s):t};return t.plural=function(t,s){const n=`${t}:${lichess.quantity(s)}`,o=e[n]||e[t];return o?j(o,Array.prototype.slice.call(arguments,1)):t},t.noarg=t=>e[t]||t,t.vdom=(t,...s)=>{const n=e[t];return n?F(n,s):[t]},t.vdomPlural=(t,s,...n)=>{const o=`${t}:${lichess.quantity(s)}`,i=e[o]||e[t];return i?F(i,n):[t]},t},W=R(lichess.siteI18n),B=[["nbYearsAgo","inNbYears",31536e3,1],["nbMonthsAgo","inNbMonths",2628e3,1],["nbWeeksAgo","inNbWeeks",604800,1],["nbDaysAgo","inNbDays",86400,2],["nbHoursAgo","inNbHours",3600,1],["nbMinutesAgo","inNbMinutes",60,1],["nbSecondsAgo","inNbSeconds",1,9],["rightNow","justNow",1,0]],H=e=>e instanceof Date?e:new Date(isNaN(e)?e:parseInt(e)),V=e=>{const t=Math.abs(e),s=B.find((e=>t>=e[2]*e[3]));return W.plural(s[e<0?1:0],Math.floor(t/s[2]))};let J;const G=()=>J=J||(window.Intl&&Intl.DateTimeFormat?new Intl.DateTimeFormat(document.documentElement.lang,{year:"numeric",month:"short",day:"numeric",hour:"numeric",minute:"numeric"}).format:e=>e.toLocaleString()),z=e=>V((Date.now()-H(e).getTime())/1e3),Y=e=>requestAnimationFrame((()=>{const t=Date.now();[].slice.call((e||document).getElementsByClassName("timeago"),0,99).forEach((e=>{const s=e.classList,n=s.contains("abs"),o=s.contains("set");if(e.lichessDate=e.lichessDate||H(e.getAttribute("datetime")),!o){const t=G()(e.lichessDate);n?e.textContent=t:e.setAttribute("title",t),s.add("set"),(n||s.contains("once"))&&s.remove("timeago")}if(!n){const n=(t-e.lichessDate.getTime())/1e3;e.textContent=V(n),Math.abs(n)>9999&&s.remove("timeago")}}))})),K=e=>{Y(),setTimeout((()=>K(1.1*e)),e)},X=(e,t)=>{window.requestIdleCallback?window.requestIdleCallback(e,t?{timeout:t}:void 0):requestAnimationFrame(e)},Q=e=>/[&<>"']/.test(e)?e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/'/g,"&#39;").replace(/"/g,"&quot;"):e;let Z;const ee=()=>{Z&&clearTimeout(Z),Z=void 0,$("#announce").remove()},te=e=>{ee(),e.msg&&($("body").append('<div id="announce" class="announce">'+Q(e.msg)+(e.date?'<time class="timeago" datetime="'+e.date+'"></time>':"")+'<div class="actions"><a class="close">×</a></div></div>').find("#announce .close").on("click",ee),Z=setTimeout(ee,e.date?new Date(e.date).getTime()-Date.now():5e3),e.date&&lichess.contentLoaded())};function se(){$("#agreement form").on("submit",(e=>{const t=e.target;return(e=>{const t=e.getAttribute("action");t?m(t,{method:e.method,body:new FormData(e)}):Promise.reject(`Form has no action: ${e}`)})(t),t.parentNode.remove(),!1}))}const ne=(e,t={})=>{const s=(t=t||{}).sameDomain?"":document.body.getAttribute("data-asset-url"),n=t.version||document.body.getAttribute("data-asset-version");return s+"/assets"+(t.noVersion?"":"/_"+n)+"/"+e},oe=new Map,ie=e=>{if(!oe.has(e)){const t=document.createElement("link");t.rel="stylesheet",t.href=ne(e),oe.set(e,new Promise((e=>{t.onload=()=>e()}))),document.head.append(t)}return oe.get(e)},ae=e=>ie(`css/${e}.${$("body").data("theme")}.${$("body").data("dev")?"dev":"min"}.css`),re=e=>`compiled/${e}${$("body").data("dev")?"":".min"}.js`,ce=new Map,le=(e,t={})=>{var s;return ce.has(e)||ce.set(e,(s=ne(e,t),new Promise(((e,t)=>{const n=document.body.getAttribute("data-nonce"),o=document.createElement("script");n&&o.setAttribute("nonce",n),o.onload=e,o.onerror=t,o.src=s,document.head.append(o)})))),ce.get(e)},de=e=>le(re(e)),he=async(e,t)=>(await de(e),window[t]),ue=async()=>(ae("complete"),await de("userComplete"),window.UserComplete),pe=()=>(ie("vendor/hopscotch/dist/css/hopscotch.min.css"),le("vendor/hopscotch/dist/js/hopscotch.min.js",{noVersion:!0}));function me(e){return new Promise((t=>requestAnimationFrame((()=>{e.loadCss=ae,t(window.LichessChat(document.querySelector(".mchat"),e))}))))}const ge=e=>{var t;return null===(t=document.querySelector(".crosstable"))||void 0===t?void 0:t.contains(e)},fe=(e,t)=>s=>{const n=($(s).data("href")||s.href).replace(/\?.+$/,"");t&&t(n),m(n+"/mini").then((t=>{const s=document.getElementById(e);s.innerHTML=t,lichess.contentLoaded(s)}))},be=(e,t)=>`<a class="btn-rack__btn" href="${e}" data-icon="${t}"></a>`,ve=(e,t)=>$(e).removeClass("ulpt").powerTip({preRender:fe("powerTip",(t=>{const s=t.slice(3),n=$(e).data("name")||$(e).html();$("#powerTip").html('<div class="upt__info"><div class="upt__info__top"><span class="user-link offline">'+n+'</span></div></div><div class="upt__actions btn-rack">'+be("/@/"+s+"/tv","")+be("/inbox/new?user="+s,"")+be("/?user="+s+"#friend","")+'<a class="btn-rack__btn relation-button" disabled></a></div>')})),placement:t||e.getAttribute("data-pt-pos")||(ge(e)?"n":"s")}),we=e=>$(e).removeClass("glpt").powerTip({preRender:fe("miniGame",(()=>lichess.spinnerHtml)),placement:ge(e)?"n":"w",popupId:"miniGame"});function ye(e,t,s){"ontouchstart"in window||(s(e),$.powerTip.show(e,t))}function ke(e,t,s){X((()=>Array.prototype.forEach.call(e.querySelectorAll(t),(e=>s(e)))),800)}const $e={watchMouse(){document.body.addEventListener("mouseover",(e=>{const t=e.target;t.classList.contains("ulpt")?ye(t,e,ve):t.classList.contains("glpt")&&ye(t,e,we)}))},manualGameIn(e){ke(e,".glpt",we)},manualGame:we,manualUser:ve,manualUserIn(e){ke(e,".ulpt",ve)}},Se=Object.create(null),Ce={on(e,t){(Se[e]=Se[e]||[]).push(t)},off(e,t){const s=Se[e];if(s)for(const n in s)if(s[n]===t){s.splice(+n);break}},emit(e,...t){for(const s of Se[e]||[])s.apply(null,t)}},_e=new class{constructor(){this.soundSetSounds=new Map,this.standaloneSounds=new Map,this.soundSet=$("body").data("sound-set"),this.speechStorage=T.makeBoolean("speech.enabled"),this.volumeStorage=T.make("sound-volume"),this.baseUrl=ne("sound",{version:"_____1"}),this.loadOggOrMp3=(e,t,s=!1)=>(s?this.standaloneSounds:this.soundSetSounds).set(e,new Howl({src:["ogg","mp3"].map((e=>`${t}.${e}`))})),this.loadStandard=(e,t)=>{if(!this.enabled())return;const s=e[0].toUpperCase()+e.slice(1);this.loadOggOrMp3(e,`${this.baseUrl}/${t||this.soundSet}/${s}`)},this.getOrLoadSound=(e,t)=>{var s;let n=null!==(s=this.soundSetSounds.get(e))&&void 0!==s?s:this.standaloneSounds.get(e);return n||(this.loadStandard(e,t),n=this.soundSetSounds.get(e)),n},this.setVolume=this.volumeStorage.set,this.getVolume=()=>{const e=parseFloat(this.volumeStorage.get()||"");return e>=0?e:.7},this.enabled=()=>"silent"!==this.soundSet,this.speech=e=>(void 0!==e&&this.speechStorage.set(e),this.speechStorage.get()),this.say=(e,t=!1,s=!1,n=!1)=>{if(t&&speechSynthesis.cancel(),!this.speechStorage.get()&&!s)return!1;const o=new SpeechSynthesisUtterance(e);return o.volume=this.getVolume(),o.lang=n?document.documentElement.lang:"en-US",speechSynthesis.speak(o),!0},this.sayOrPlay=(e,t)=>this.say(t)||this.play(e),this.publish=()=>Ce.emit("sound_set",this.soundSet),this.changeSet=e=>{this.soundSet=e,this.soundSetSounds.clear(),this.publish()},this.set=()=>this.soundSet,"music"==this.soundSet&&setTimeout(this.publish,500)}preloadBoardSounds(){"music"!==this.soundSet&&["move","capture","check","genericNotify"].forEach((e=>this.loadStandard(e)))}play(e,t){var s;if(!this.enabled())return;let n=this.soundSet;if("music"===n||this.speechStorage.get()){if(["move","capture","check"].includes(e))return;n="standard"}const o=this.getOrLoadSound(e,n),i=()=>o.volume(this.getVolume()*(t||1)).play();"suspended"===(null===(s=Howler.ctx)||void 0===s?void 0:s.state)?Howler.ctx.resume().then(i):i()}playOnce(e){const t=()=>{const t=lichess.storage.make("just-played");Date.now()-parseInt(t.get(),10)<1e3||(t.set(""+Date.now()),this.play(e))};document.hasFocus()?t():setTimeout(t,10+500*Math.random())}};let Te;function Ae(e){const t=$(e);if(t.data("watched"))return;t.data("watched",1);const s=$('<div class="chat__members__inner">').appendTo(t),n=$('<div class="chat__members__number" data-icon="" title="Spectators"></div>').appendTo(s),o=$("<div>").appendTo(s);lichess.pubsub.on("socket.in.crowd",(e=>i(e.watchers||e)));const i=e=>{if(Te=e,e&&e.nb){if(n.text(""+e.nb),e.users){const t=e.users.map((e=>e||"")).join(";");if(o.data("prevUsers")!==t){o.data("prevUsers",t);const s=e.users.map((e=>e?`<a class="user-link ulpt" href="/@/${(e=>e.includes(" ")?e.split(" ")[1]:e)(e)}">${e}</a>`:"Anonymous"));1===e.anons?s.push("Anonymous"):e.anons&&s.push(`Anonymous (${e.anons})`),o.html(s.join(", "))}}else o.html("");t.removeClass("none")}else t.addClass("none")};Te&&i(Te)}console.info("Lichess is open source! https://lichess.org/source");class Me{constructor(e){this.el=e,this.loaded=!1,this.receive=(e,t)=>{this.users.clear(),e.forEach(this.insert),t.playing.map((e=>this.users.get(e))).filter(h).forEach((e=>e.playing=!0)),t.patrons.map((e=>this.users.get(e))).filter(h).forEach((e=>e.patron=!0)),this.repaint()},this.repaint=()=>{this.loaded&&requestAnimationFrame((()=>{var e;const t=Array.from(this.users.keys()).sort();this.titleEl.innerHTML=W.plural("nbFriendsOnline",t.length,this.loaded?`<strong>${t.length}</strong>`:"-"),null===(e=this.el.querySelector(".nobody"))||void 0===e||e.classList.toggle("none",!!t[0]),this.el.querySelector(".list").innerHTML=t.map((e=>this.renderFriend(this.users.get(e)))).join("")}))},this.renderFriend=e=>{const t=`<i class="line${e.patron?" patron":""}"></i>`,s=e.title?`<span class="utitle"${"BOT"===e.title?" data-bot":""}>${e.title}</span>&nbsp;`:"",n="/@/"+e.name,o=e.playing?`<a data-icon="" class="tv ulpt" data-pt-pos="nw" href="${n}/tv" data-href="${n}"></a>`:"";return`<div><a class="user-link ulpt" data-pt-pos="nw" href="${n}">${t}${s}${e.name}</a>${o}</div>`},this.enters=(e,t)=>{const s=this.insert(e);s.playing=t.playing,s.patron=t.patron,this.repaint()},this.leaves=e=>{this.users.delete(this.getId(e)),this.repaint()},this.playing=e=>{this.insert(e).playing=!0,this.repaint()},this.stopped_playing=e=>{this.insert(e).playing=!1,this.repaint()},this.insert=e=>{const t=this.getId(e);return this.users.has(t)||this.users.set(t,this.toFriend(e)),this.users.get(t)},this.getId=e=>e.toLowerCase().replace(/^\w+\s/,""),this.toFriend=e=>{const t=e.split(" ");return{id:t[t.length-1].toLowerCase(),name:t[t.length-1],title:t.length>1?t[0]:void 0,playing:!1,patron:!1}},this.titleEl=this.el.querySelector(".friend_box_title"),this.titleEl.addEventListener("click",(()=>{var e;null===(e=this.el.querySelector(".content_wrap"))||void 0===e||e.classList.toggle("none"),this.loaded||(this.loaded=!0,Ce.emit("socket.send","following_onlines"))})),this.users=new Map,Ce.on("socket.in.following_onlines",this.receive),["enters","leaves","playing","stopped_playing"].forEach((e=>Ce.on("socket.in.following_"+e,this[e])))}}function Le(e){var t;const s=$("#modal-wrap")[0];if(!s)return;const n=s.compareDocumentPosition(e.target);if(n&Node.DOCUMENT_POSITION_CONTAINED_BY)return;const o=$(s).find('button:not(:disabled), [href], input:not(:disabled):not([type="hidden"]), select:not(:disabled), textarea:not(:disabled), [tabindex="0"]'),i=n&Node.DOCUMENT_POSITION_FOLLOWING?0:o.length-1;null===(t=o.get(i))||void 0===t||t.focus(),e.preventDefault()}(()=>{const e=window.lichess;e.StrongSocket=E,e.requestIdleCallback=X,e.sri=w,e.storage=T,e.tempStorage=A,e.once=M,e.powertip=$e,e.clockWidget=r,e.spinnerHtml='<div class="spinner" aria-label="loading"><svg viewBox="-2 -2 54 54"><g mask="url(#mask)" fill="none"><path id="a" stroke-width="3.779" d="m21.78 12.64c-1.284 8.436 8.943 12.7 14.54 17.61 3 2.632 4.412 4.442 5.684 7.93"/><path id="b" stroke-width="4.157" d="m43.19 36.32c2.817-1.203 6.659-5.482 5.441-7.623-2.251-3.957-8.883-14.69-11.89-19.73-0.4217-0.7079-0.2431-1.835 0.5931-3.3 1.358-2.38 1.956-5.628 1.956-5.628"/><path id="c" stroke-width="4.535" d="m37.45 2.178s-3.946 0.6463-6.237 2.234c-0.5998 0.4156-2.696 0.7984-3.896 0.6388-17.64-2.345-29.61 14.08-25.23 27.34 4.377 13.26 22.54 25.36 39.74 8.666"/></g></svg></div>',e.assetUrl=ne,e.loadCss=ie,e.loadCssPath=ae,e.jsModule=re,e.loadScript=le,e.loadModule=de,e.loadIife=he,e.hopscotch=pe,e.userComplete=ue,e.makeChat=me,e.idleTimer=b,e.pubsub=Ce,e.unload=S,e.redirect=k,e.reload=C,e.watchers=Ae,e.escapeHtml=Q,e.announce=te,e.trans=R,e.sound=_e,e.miniBoard=a,e.miniGame=U,e.timeago=z,e.dateFormat=G,e.contentLoaded=e=>Ce.emit("content-loaded",e)})(),lichess.info={date:"2022-07-01T19:57:58+00:00",commit:"9f5143ec7bebf7502296e780f03be120f61dbb26",message:"Merge pull request #11081 from xcjackpan/fix-chapter-tour"},lichess.load.then((()=>{$("#user_tag").removeAttr("href"),requestAnimationFrame((()=>{i(),x(),Ce.on("content-loaded",i),Ce.on("content-loaded",x),K(1e3),Ce.on("content-loaded",Y)})),X((()=>{const e=document.getElementById("friend_box");e&&new Me(e);const t=document.querySelector(".chat__members");if(t&&Ae(t),$("#main-wrap").on("click",".autoselect",(function(){this.select()})).on("click","button.copy",(function(){$("#"+$(this).data("rel")).each((function(){this.select()})),document.execCommand("copy"),$(this).attr("data-icon","")})),$("body").on("click","a.relation-button",(function(){const e=$(this).addClass("processing").css("opacity",.3);return m(this.href,{method:"post"}).then((t=>{t.includes("relation-actions")?e.parent().replaceWith(t):e.replaceWith(t)})),!1})),$(".mselect .button").on("click",(function(){const e=$(this).parent();e.toggleClass("shown"),X((()=>{const t=s=>{e[0].contains(s.target)||(e.removeClass("shown"),$("html").off("click",t))};$("html").on("click",t)}),200)})),$e.watchMouse(),setTimeout((()=>{lichess.socket||(lichess.socket=new E("/socket/v5",!1))}),300),function(){const e=`<div class="initiating">${lichess.spinnerHtml}</div>`,t=e=>{const t=document.querySelector(e),s=t&&window.getComputedStyle(t).display;return s&&"none"!=s};"ontouchstart"in window&&!window.matchMedia("(max-width: 979px)").matches&&$("#topnav > section > a").removeAttr("href"),$("#topnav-toggle").on("change",(e=>document.body.classList.toggle("masked",e.target.checked))),$("#top").on("click","a.toggle",(function(){const e=$(this).parent().toggleClass("shown");return e.siblings(".shown").removeClass("shown"),Ce.emit("top.toggle."+this.id),setTimeout((()=>{const t=s=>{var n;(null===(n=e[0])||void 0===n?void 0:n.contains(s.target))||(e.removeClass("shown"),$("html").off("click",t))};$("html").on("click",t)}),10),!1}));{let s,n;const o=$("#challenge-toggle");o.one("mouseover click",(()=>i()));const i=function(i){if(n)return;n=!0;const a=$("#challenge-app").html(e);ae("challenge"),de("challenge").then((()=>s=window.LichessChallenge(a[0],{data:i,show(){t("#challenge-app")||o.trigger("click")},setCount(e){o.find("span").data("count",e)},pulse(){o.addClass("pulse")}})))};Ce.on("socket.in.challenges",(e=>{s?s.update(e):i(e)})),Ce.on("challenge-app.open",(()=>o.trigger("click")))}{let s,n;const o=$("#notify-toggle"),i="#notify-app",a=(a,r=!1)=>{if(n)return;n=!0;const c=$("#notify-app").html(e);ae("notify"),de("notify").then((()=>{s=window.LichessNotify(c.empty()[0],{data:a,incoming:r,isVisible:()=>t(i),setCount(e){o.find("span").data("count",e)},show(){t(i)||o.trigger("click")},setNotified(){lichess.socket.send("notified")},pulse(){o.addClass("pulse")}})}))};o.one("mouseover click",(()=>a())).on("click",(()=>{"Notification"in window&&Notification.requestPermission(),setTimeout((()=>{s&&t(i)&&s.setVisible()}),200)})),Ce.on("socket.in.notifications",(e=>{s?s.update(e,!0):a(e,!0)})),Ce.on("notify-app.set-read",(e=>{s?s.setMsgRead(e):a()}))}{let t;$("#top .dasher .toggle").one("mouseover click",(function(){if(t)return;t=!0,$(this).removeAttr("href");const s=$("#dasher_app").html(e),n=$("body").hasClass("playing");ae("dasher"),de("dasher").then((()=>window.LichessDasher(s.empty()[0],{playing:n})))}))}{const e=$("#clinput");if(!e.length)return;const t=e.find("input");let s=!1;const n=()=>{s||(s=!0,de("cli").then((()=>window.LichessCli.app(t[0])),(()=>s=!1)))};t.on({blur(){t.val(""),$("body").removeClass("clinput")},focus(){n(),$("body").addClass("clinput")}}),e.find("a").on({mouseover:n,click(){$("body").hasClass("clinput")?t[0].blur():t[0].focus()}}),window.Mousetrap.bind("/",(()=>{t.val("/"),t[0].focus()})).bind("s",(()=>t[0].focus()))}}(),window.addEventListener("resize",(()=>document.body.dispatchEvent(new Event("chessground.resize")))),$(".user-autocomplete").each((function(){const e=!!this.autofocus,t=()=>ue().then((t=>t({input:this,friend:$(this).data("friend"),tag:$(this).data("tag"),focus:e})));e?t():$(this).one("focus",t)})),window.InfiniteScroll&&window.InfiniteScroll(".infinite-scroll"),$("input.confirm, button.confirm").on("click",(function(){return confirm(this.title||"Confirm this action?")})),$("#main-wrap").on("click","a.bookmark",(function(){const e=$(this).toggleClass("bookmarked");m(this.href,{method:"post"});const t=(parseInt(e.text(),10)||0)+(e.hasClass("bookmarked")?1:-1);return e.find("span").html(""+(t>0?t:"")),!1})),$("body").on("focusin",Le),window.Mousetrap.bind("esc",(()=>{const e=$("#modal-wrap .close");if(e.length)e.trigger("click");else{const e=$(":focus");e.length&&e.trigger("blur")}})),navigator.userAgent.includes("Edge/")&&setTimeout((()=>{const e=document.getElementById("piece-sprite");e.href=e.href.replace(".css",".external.css")}),1e3),/iPad|iPhone|iPod/.test(navigator.userAgent)&&!("MSStream"in window)){const e=document.querySelector("meta[name=viewport]");e.setAttribute("content",e.getAttribute("content")+",maximum-scale=1.0")}"#blind"!==location.hash||$("body").hasClass("blind-mode")||m("/toggle-blind-mode",{method:"post",body:f({enable:1,redirect:"/"})}).then(C);const s=document.body.getAttribute("data-announce");s&&te(JSON.parse(s)),se(),function(){if("serviceWorker"in navigator&&"Notification"in window&&"PushManager"in window){const e=new URL(ne(re("serviceWorker"),{sameDomain:!0}),self.location.href);e.searchParams.set("asset-url",document.body.getAttribute("data-asset-url")),document.body.getAttribute("data-dev")&&e.searchParams.set("dev","1");const t=document.body.getAttribute("data-dev")?"none":"all";navigator.serviceWorker.register(e.href,{scope:"/",updateViaCache:t}).then((e=>{const t=T.make("push-subscribed"),s=document.body.getAttribute("data-vapid");s&&"granted"==Notification.permission?e.pushManager.getSubscription().then((n=>{const o=parseInt(t.get()||"0",10)+432e5<Date.now(),i=Uint8Array.from(atob(s),(e=>e.charCodeAt(0)));n&&!o||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:i}).then((e=>fetch("/push/subscribe",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)}).then((e=>{e.ok?t.set(""+Date.now()):console.log("submitting push subscription failed",e.statusText)}))),(e=>{console.log("push subscribe failed",e.message),n&&n.unsubscribe()}))})):t.remove()}))}}(),Ce.on("socket.in.redirect",(e=>{lichess.unload.expected=!0,lichess.redirect(e)})),Ce.on("socket.in.fen",(e=>document.querySelectorAll(".mini-game-"+e.id).forEach((t=>P(t,e))))),Ce.on("socket.in.finish",(e=>document.querySelectorAll(".mini-game-"+e.id).forEach((t=>q(t,e.win))))),Ce.on("socket.in.announce",te),Ce.on("socket.in.tournamentReminder",(e=>{if($("#announce").length||$("body").data("tournament-id")==e.id)return;const t="/tournament/"+e.id;$("body").append($('<div id="announce">').append($('<a data-icon="" class="text">').attr("href",t).text(e.name)).append($('<div class="actions">').append($('<a class="withdraw text" data-icon="">').attr("href",t+"/withdraw").text(W("pause")).on("click",(function(){return m(this.href,{method:"post"}),$("#announce").remove(),!1}))).append($('<a class="text" data-icon="">').attr("href",t).text(W("resume")))))}))}),800)}))}();
